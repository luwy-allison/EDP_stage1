...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\user\\Desktop\\EDP_stage1\\practice\\practice.py',
...
thisExp.addData('interface_phase.started', interface_phase.tStart)
thisExp.addData('interface_phase.stopped', interface_phase.tStop)
...
for thisComponent in TOComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('interface_TO.started', interface_TO.tStartRefresh)
thisExp.addData('interface_TO.stopped', interface_TO.tStopRefresh)
# store data for thisExp (ExperimentHandler)
...
for thisComponent in CEComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('interface_CE.started', interface_CE.tStartRefresh)
thisExp.addData('interface_CE.stopped', interface_CE.tStopRefresh)
# store data for thisExp (ExperimentHandler)
thisExp.nextEntry()
